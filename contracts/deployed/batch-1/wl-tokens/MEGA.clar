...
(define-fungible-token mega u100 000 000)
...
;; supply constants
(define-constant dao-supply u48 000 000)
(define-constant team-supply u10 000 000)
(define-constant distribution-supply u42 000 000)
;; supply wallets
